...
namespace LUtil.Collections {
    public class DoubleDict<TForward, TBackward> : IDictionary<TForward, TBackward> {
        ...
        private void AddEvents() {
            _forwardInternal.ItemSet += ( sender, kp ) => _backwardInternal.DictionaryImplementation[kp.Value] = kp.Key;
            _backwardInternal.ItemSet += ( sender, kp ) => _forwardInternal.DictionaryImplementation[kp.Value] = kp.Key;
            _forwardInternal.ItemRemoved +=
                ( sender, kp ) => _backwardInternal.DictionaryImplementation.Remove( kp.Value );
            _backwardInternal.ItemRemoved +=
                ( sender, kp ) => _forwardInternal.DictionaryImplementation.Remove( kp.Value );
            _forwardInternal.DictionaryCleared += ( sender, _ ) => _backwardInternal.DictionaryImplementation.Clear();
            _backwardInternal.DictionaryCleared += ( sender, _ ) => _forwardInternal.DictionaryImplementation.Clear();
        }
